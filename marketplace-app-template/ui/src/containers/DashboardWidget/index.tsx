...
const DashboardWidget: React.FC = function () {
    ...
    useEffect(() => {
        ContentstackAppSdk.init()
            .then(async (appSdk) => {
                ...
                console.log("DashboardWidget - environmentsResponse:", environmentsResponse);
                ...
                try {
                    ...
                    console.log("DashboardWidget - Lytics segments response:", lyticsResponse);
                } catch (error) {
    ...
    const fetchHeatmapData = async (heatmapType: string) => {
        ...
        try {
            const response = await services.getHeatmapMetrics(selectedWebsite?.value || '');
