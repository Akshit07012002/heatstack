...
const DashboardWidget: React.FC = function () {
  ...
  useEffect(() => {
    ContentstackAppSdk.init()
      .then(async (appSdk) => {
        ...
        console.log(
          "DashboardWidget - environmentsResponse:",
        ...
        console.log("DashboardWidget - websites:", websites);
        ...
        try {
          ...
          console.log(
            "DashboardWidget - Lytics segments response:",
            lyticsResponse
          );
        } catch (error) {
  ...
  }, [isLoading, heatmapData, error, showHeatmap]);
  ...
  const fetchHeatmapData = async (heatmapType: string) => {
    ...
    try {
      ...
      console.log("DashboardWidget - Heatmap metrics response:", response);
