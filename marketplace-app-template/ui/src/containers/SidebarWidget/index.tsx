  ...
  useEffect(() => {
    ContentstackAppSdk.init()
      .then(async (appSdk) => {
        ...
        setEntryData(entryDataFromSDK || { title: "" }); // entryData is the whole entry object from CMS that contains all the data in the current entry for which sidebar is opened.
        setState({
          config,
